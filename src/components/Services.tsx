      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((s) => (
            <div
              key={s.title}
              className="group rounded-2xl overflow-hidden bg-white border border-[#e8e3dc] shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:border-[#c8964e]/30"
            >
              ...
              <div className="p-8">
                <h3 className="font-display text-[24px] sm:text-[28px] text-[#1a1a1a] tracking-tight">{s.title}</h3>
                <p className="mt-3 text-[15px] text-[#6b6560] leading-relaxed">{s.desc}</p>
                <Link
                  href={s.href}
                  className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#c8964e] px-7 py-3 text-[14px] font-semibold text-white shadow-[0_2px_12px_rgba(200,150,78,0.25)] transition-all duration-200 hover:bg-[#b07d3a] hover:shadow-[0_4px_20px_rgba(200,150,78,0.4)] hover:scale-[1.02]"
                >
                  {s.button}
