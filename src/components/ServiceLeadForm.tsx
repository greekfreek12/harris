...
export default function ServiceLeadForm({ id, variant }: ServiceLeadFormProps) {
  ...
  return (
    <section id={id} className="border-t border-[#ede8e1] bg-[#f8f6f3] py-24 lg:py-28 scroll-mt-20">
      <div className="mx-auto max-w-2xl px-6 sm:px-8">
        ...
        {submitted ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-[#e2ddd6] bg-white shadow-[0_8px_30px_rgba(0,0,0,0.05)]">
